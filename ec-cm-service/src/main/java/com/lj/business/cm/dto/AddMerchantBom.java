 ...
 */
public class AddMerchantBom implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -2900718050042726378L;
	...
	public String toString() {
		return "AddMerchantBom [code=" + code + ", merchantNo=" + merchantNo
