...
public class EditPersonMember implements Serializable{
	...
	/**
	 * Gets the 客户分类关联表的code(必填).
	 *
	 * @return the 客户分类关联表的code(必填)
	 */
	...
	/**
	 * Sets the 客户分类关联表的code(必填).
	 *
	 * @param pmTypePmCode the new 客户分类关联表的code(必填)
	 */
	...
	public String toString() {
		...
		builder.append("EditPersonMember [code=").append(code)
				...
				.append(", codePm=").append(codePm).append(", memberNoGm=")
				.append(memberNoGm).append(", memberNameGm=")
				.append(memberNameGm).append(", shopNo=").append(shopNo)
				.append(", shopName=").append(shopName).append(", merchantNo=")
				.append(merchantNo).append(", merchantName=")
				.append(merchantName).append(", spruceUp=").append(spruceUp)
				.append(", houses=").append(houses).append(", keepEye=")
				.append(keepEye).append(", urgencyPm=").append(urgencyPm)
				.append(", bomCode=").append(bomCode).append(", bomName=")
				.append(bomName).append(", nickNameRemarkWx=")
				.append(nickNameRemarkWx).append(", pmTypeCode=")
				.append(pmTypeCode).append(", pmTypePmCode=")
				.append(pmTypePmCode).append(", operater=").append(operater)
				.append(", birthday=").append(birthday)
				.append(", brandCompare=").append(brandCompare)
				.append(", clientSpecial=").append(clientSpecial).append("]");
