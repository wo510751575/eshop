 ...
 */
@Service
public class BehaviorPmServiceImpl implements IBehaviorPmService { 

	
	/** Logger for this class. */
	private static final Logger logger = LoggerFactory.getLogger(BehaviorPmServiceImpl.class);
