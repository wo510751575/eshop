...
public class BaseController {
	 ...
	 *
	 */
	public String getGuidMemberCode(){
		LoginUserDto user=UserTokenThreadLocal.get();
		if (user != null && user.getGuidMbr() != null) {
			return user.getGuidMbr().getCode();
		}
		return null;
	}
	/**
	 ...
	 *
	 */
	public GuidMbrDto getGuidMember(){
		LoginUserDto user=UserTokenThreadLocal.get();
		if (user != null && user.getGuidMbr() != null) {
			return user.getGuidMbr();
		}
		return null;
	}
	...
	public String getGuidMemberNo(){
		LoginUserDto user=UserTokenThreadLocal.get();
		if (user != null && user.getGuidMbr() != null) {
			return user.getGuidMbr().getMemberNo();
		}
		return null;
	}
}
