...
//    }
	...
	@ResponseBody
    public ResponseDto login(String wxCode,String merchantCode){
...
//		}
	...
	private WxUserInfoDto createWxUserInfo(String wxCode){
		...
		dto.setCountry("CN");
		dto.setHeadimgurl("http://wx.qlogo.cn/mmopen/g3MonUZtNHkdmzicIlibx6iaFqAc56vxLSUfpb6n5WKSYVY0ChQKkiaJSgQ1dZuTOgvLLrhJbERQQ4eMsv84eavHiaiceqxibJxCfHe/46");
	...
	@ResponseBody
	public ResponseDto bindOpenId(String wxCode){
		if(StringUtils.isBlank(wxCode)){
			return ResponseDto.getErrorResponse(ResponseCode.PARAM_ERROR);
		}
		String merchantCode = getLoginMerchantCode();
		LOG.info("绑定微信openId[wxCode:"+wxCode+",merchantCode:"+merchantCode);
		WxUserInfoDto wxUser = null;
//		if(DevConfig.isDevTest()){
//			wxUser=createWxUserInfo(wxCode);
//		}else{
			wxUser =weixinApiService.getUserInfo(wxCode,merchantCode);
//		}
		userLoginService.bindOpenId(wxUser);
