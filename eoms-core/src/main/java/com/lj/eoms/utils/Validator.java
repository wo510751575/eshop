...
//            "(^([2-9][0-9][13579][26])([-\\/\\._]?)(0?2)([-\\/\\._]?)(29)$))";  
     ...
     *  YYYY-MM-DD 的形式 
     */ 
    public static final String DATE_ALL="^[0-9]{4}-(((0[13578]|(10|12))-(0[1-9]|[1-2][0-9]|3[0-1]))|(02-(0[1-9]|[1-2][0-9]))|((0[469]|11)-(0[1-9]|[1-2][0-9]|30)))$";
...
////------------------验证方法       
    ...
    public static synchronized boolean StrisNull(String str) {  
        return null == str || str.trim().length() <= 0||str.equals("null") ? true : false ;  
    }  
    /** 
     * 判断字段是非空 符合返回ture 
     * @param str 
    ...
    public static  boolean isScientific(String str){  
        if(StrisNull(str))  
            return false;   
        return Regular(str,Validator.SCIENTIFIC_A);  
    }     
    
    
    public static void main(String[] args) {  
        System.out.println(Validator.isDate("1994/12/25"));
       }  
}
