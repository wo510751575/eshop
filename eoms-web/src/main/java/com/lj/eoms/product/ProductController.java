...
public class ProductController  extends BaseController {
	...
	public String list(FindProductPage productPage, Integer pageNo,
	...
	public String save(ProductDto productDto,String imgAddr,
		...
		if(productDto.getSkus()!=null){
			...
			for (int i = 0; i < size; i++) {
				...
				productSkuService.addProductSku(sku);
			}
		}
		//商品价格END
	...
	public String form(String code,Boolean isView, Model model) {
		if(!StringUtils.isEmpty(code)){
			...
			model.addAttribute("productRules", productRules);//商品规格及规格属性值
	...
	public String edit(ProductDto productDto,String imgAddr,
			RedirectAttributes redirectAttributes) {
		...
		addMessage(redirectAttributes, "修改商品'" + productDto.getName() 
				+ "'成功");
		return "redirect:" + adminPath + "/product/product/";
	}
	...
	public String status(ProductDto productDto,
			RedirectAttributes redirectAttributes) {
	...
	@ResponseBody
	public ResponseDto editSku(ProductSkuDto sku){
