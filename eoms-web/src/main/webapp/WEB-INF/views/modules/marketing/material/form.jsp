...
<div class="container">
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/marketing/materialcommon/">卖家素材列表</a></li>
		<li class="active"><a href="${ctx}/marketing/materialcommon/form?code=${data.code}">卖家素材<shiro:hasPermission name="content:wshopinfo:edit">${not empty data.code?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="content:wshopinfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
