	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('.view_btn').click(function() {
				...
				// 正常打开	
				top.$.jBox.open("iframe:${ctx}/marketing/materialcommon/form?code="+code+"&isView="+true,"官方素材详情", 800, 560,{//宽高
					id:9527,
					draggable: true,
					showClose: true,
					buttons:{},		//去除按钮
...
<div class="container">
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/marketing/materialcommon/">官方素材列表</a></li>
		<shiro:hasPermission name="marketing:materialcommon:edit"><li><a href="${ctx}/marketing/materialcommon/form">官方素材添加</a></li></shiro:hasPermission>
	</ul>
		<form id="searchForm" action="${ctx}/marketing/materialcommon/list" method="post" class="breadcrumb form-search">
	...
	<tags:message content="${message}"/>
		<table id="treeTable" class="table table-striped table-bordered table-condensed hide">
			...
			<c:forEach items="${page.list}" var="item">
				<tr id="${item.code}">
					<td title="${item.title}"><a href="${ctx}/marketing/materialcommon/form?code=${item.code}">${item.title}</a></td>
					...
					<shiro:hasPermission name="marketing:materialcommon:edit"><td nowrap>
						<a href="${ctx}/marketing/materialcommon/form?code=${item.code}">修改</a>
					</td>
					</shiro:hasPermission>
				</tr>
			</c:forEach></tbody>
