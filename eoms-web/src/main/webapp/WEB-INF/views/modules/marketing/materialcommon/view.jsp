	...
	<div class="container">
		<div class="store-details">
			<table class="table-form" style="width: 100%;">
				<tbody>
					<tr>
						<td style="text-align: right; font-weight: bold; width: 120px;">标题 ：</td>
						<td>${data.title}</td>
					</tr>
					<tr>
						<td style="text-align: right; font-weight: bold;">商品编码 ：</td>
						<td>${data.productCode}</td>
					</tr>
					<tr>
						<td style="text-align: right; font-weight: bold;">分享次数 ：</td>
						<td>${data.shareCnt}</td>
					</tr>
					<tr>
					...
					<tr>
						<td style="text-align: right; font-weight: bold; clear: both;">备注：</td>
						<td>${data.remarks}</td>
					</tr>
