 ...
 */
@Service
public class EcLoginCheckServiceImpl implements IEcLoginCheckService { 

	
	/** Logger for this class. */
	private static final Logger logger = LoggerFactory.getLogger(EcLoginCheckServiceImpl.class);
