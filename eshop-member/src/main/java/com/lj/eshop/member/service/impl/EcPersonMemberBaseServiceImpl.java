 ...
 */
@Service
public class EcPersonMemberBaseServiceImpl implements IEcPersonMemberBaseService { 

	
	/** Logger for this class. */
	private static final Logger logger = LoggerFactory.getLogger(EcPersonMemberBaseServiceImpl.class);
