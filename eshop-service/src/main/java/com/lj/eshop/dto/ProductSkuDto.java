...
public class ProductSkuDto implements Serializable { 
	...
	public String toString() {
		return "ProductSkuDto [code=" + code + ", cnt=" + cnt
				+ ", productCode=" + productCode + ", productSpes="
				+ productSpes + ", skuNo=" + skuNo + ", delFlag=" + delFlag
				+ ", costPrice=" + costPrice + ", salePrice=" + salePrice
				+ ", orgPrice=" + orgPrice + ", gapPrice=" + gapPrice
				+ ", price=" + price + ", isDefault=" + isDefault
				+ ", skuDesc=" + skuDesc + ", orderNo=" + orderNo + "]";
	}
