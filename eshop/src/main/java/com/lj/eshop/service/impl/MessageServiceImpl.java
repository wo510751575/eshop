...
public class MessageServiceImpl implements IMessageService { 
	...
	public void addMessage(
			MessageDto messageDto) throws TsfaServiceException {
	...
	@Override
	public Page<MessageDto> findMessagePage(
			FindMessagePage findMessagePage)
			throws TsfaServiceException {
	...
	@Override
	public void addMessageByTemplate(MessageDto messageDto, MessageTemplate messageTemplate) throws TsfaServiceException {
		...
		switch(messageTemplate) {
			...
			case B_SERVICE_ORDER_BILL_COMPLETED:
				messageDto.setContent(
						messageTemplate.getChContent(
								messageDto.getcClientName(), messageDto.getcClientReceiveName(), messageDto.getcClientMoney(),
			...
			case B_SERVICE_ORDER_BILL_BACK:
				messageDto.setContent(
						messageTemplate.getChContent(
								messageDto.getcClientName(), messageDto.getcClientCommodity(), messageDto.getcClientOrderNo()
							));
				break;
	...
	@Override
	public int findMessagePageCount(FindMessagePage findMessagePage)
			throws TsfaServiceException {
		logger.debug("findMessagePage(FindMessagePage findMessagePage={}) - start", findMessagePage); //$NON-NLS-1$
